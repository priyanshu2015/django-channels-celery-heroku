from channels_celery_heroku_project.settings import TIME_ZONE
...
def notification_handler(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        schedule, created = CrontabSchedule.objects.get_or_create(hour = instance.broadcast_on.hour, minute = instance.broadcast_on.minute, day_of_month = instance.broadcast_on.day, month_of_year = instance.broadcast_on.month, timezone = "Asia/Kolkata")
